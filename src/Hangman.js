  ...
  render() {
    ...
    return (
      <div className='Hangman'>
        <h1>Hangman</h1>
        <img src={this.props.images[this.state.nWrong]} alt={`${this.state.nWrong} wrong out of ${this.props.maxWrong} guesses`} />
        ...
        <button id="Hangman-reset" onClick={this.reset}>Reset</button>
      </div>
    );
  }
}
